...
- 고객정보
    - 신규등록
        > 신규 고객이 CHEKC를 이용하기 위해선 'PID'를 발급 받아야 하며, 이 PID를 발급하기 위한 작업은 crm의 '신규등록' 기능을 통해 수행한다.
...
- 공지관리
    ...
    - 원격명령
        > 잘 사용하지 않는 것 같다. 관련 개선 요구가 초창기 이후 거의 없었음.
    ...
    - CHECK포스트잇
        ...
        > 내용이 마치 깨진 문자열처럼 보이는 것은 rtf 형식이 적용되어 있기 때문.
